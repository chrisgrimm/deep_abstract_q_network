...
class ReplayMemory(object):
    ...
    def append(self, S1, DQNNumber, A, R, MMCR, S2, T):
    ...
    def get_sample(self, index):
        ...
        return S0, dqn_number, a, r, mmc_r, S1, t, mask, mask2
    ...
    def sample(self, num_samples):
        ...
        for sample_i in idx:
            s0, dqn_number, a, r, mmc_r, s1, t, mask, mask2 = self.get_sample(sample_i)
            S0.append(s0)
        ...
        return S0, DQNNumbers, A, R, MMC_R, S1, T, M1, M2
